...
<title>selectBrand.jsp</title>
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">    
    <script type="text/javascript">
    function brandSelected()
    {	var test = document.getElementById("brand");
...
<body style="margin:0;background-color:#ECEEF0">
  ...
  <tr>
    <td align="center">
    <div id="test">
       <s:action name="brandAction!allBrand" executeResult="true"></s:action>
    </div>&nbsp;</td>
  </tr>
  <tr>
    <td align="center"><input type="button" value=" 确  定 " onClick="brandSelected()" />
